...
<div style="margin: 2.5rem 0; padding: 0; border-radius: 1.25rem; overflow: hidden; border: 1px solid rgba(167,139,250,0.25); background: var(--bg-secondary);">
  ...
  <div style="padding: 1.5rem; display: flex; flex-direction: column; gap: 0.75rem; align-items: flex-start;">
    <div style="display: flex; align-items: center; gap: 1rem; width: 100%;">
      ...
      <div style="flex: 1; font-size: 0.82rem; color: var(--text-secondary); font-style: italic;">Ce que vous observez, ce que vous ressentez</div>
    </div>
    <div style="display: flex; align-items: center; gap: 1rem; width: 100%; padding-left: 2rem;">
      ...
      <div style="color: #a78bfa; font-size: 1.2rem;">→</div>
      <div style="flex: 1; font-size: 0.82rem; color: var(--text-secondary); font-style: italic;">Les "parce que" immédiats — souvent plusieurs niveaux</div>
    </div>
    <div style="display: flex; align-items: center; gap: 1rem; width: 100%; padding-left: 4rem;">
      ...
      <div style="color: #a78bfa; font-size: 1.2rem;">→</div>
      <div style="flex: 1; font-size: 0.82rem; color: var(--text-secondary); font-style: italic;">La vraie origine — là où l'action corrective a de l'effet</div>
    </div>
  </div>
  <div style="padding: 1rem 1.5rem; border-top: 1px solid rgba(167,139,250,0.2); font-size: 0.82rem; color: var(--text-secondary);">
...
<div style="margin: 2.5rem 0; border-radius: 1.25rem; overflow: hidden; border: 1px solid rgba(167,139,250,0.2); background: var(--bg-tertiary);">
  ...
  <div style="padding: 1.5rem; display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 1rem;">
    <div style="padding: 1rem; background: rgba(167,139,250,0.07); border: 1px solid rgba(167,139,250,0.15); border-radius: 0.75rem;">
      ...
      <div style="font-weight: 600; font-size: 0.9rem; color: var(--text-primary); margin-bottom: 0.3rem;">Toyota</div>
      <div style="font-size: 0.78rem; color: var(--text-secondary);">Création par Sakichi Toyoda pour l'amélioration continue en production</div>
    </div>
    <div style="padding: 1rem; background: rgba(167,139,250,0.07); border: 1px solid rgba(167,139,250,0.15); border-radius: 0.75rem;">
      <div style="font-size: 0.72rem; font-family: 'JetBrains Mono', monospace; color: #a78bfa; margin-bottom: 0.4rem;">ANNÉES 1970–80</div>
      <div style="font-weight: 600; font-size: 0.9rem; color: var(--text-primary); margin-bottom: 0.3rem;">Lean & Six Sigma</div>
      <div style="font-size: 0.78rem; color: var(--text-secondary);">Intégration dans DMAIC, Kaizen et les systèmes qualité ISO</div>
    </div>
    <div style="padding: 1rem; background: rgba(167,139,250,0.07); border: 1px solid rgba(167,139,250,0.15); border-radius: 0.75rem;">
      <div style="font-size: 0.72rem; font-family: 'JetBrains Mono', monospace; color: #a78bfa; margin-bottom: 0.4rem;">ANNÉES 2000–10</div>
      <div style="font-weight: 600; font-size: 0.9rem; color: var(--text-primary); margin-bottom: 0.3rem;">Tech & Startups</div>
      <div style="font-size: 0.78rem; color: var(--text-secondary);">Adoption par les équipes produit, SRE, gestion d'incidents</div>
    </div>
    <div style="padding: 1rem; background: rgba(167,139,250,0.07); border: 1px solid rgba(167,139,250,0.15); border-radius: 0.75rem;">
      <div style="font-size: 0.72rem; font-family: 'JetBrains Mono', monospace; color: #a78bfa; margin-bottom: 0.4rem;">AUJOURD'HUI</div>
      <div style="font-weight: 600; font-size: 0.9rem; color: var(--text-primary); margin-bottom: 0.3rem;">Projets IA</div>
      <div style="font-size: 0.78rem; color: var(--text-secondary);">Outil clé de cadrage avant tout investissement IA en PME</div>
    </div>
  </div>
</div>
...
<div style="margin: 2.5rem 0; display: flex; flex-direction: column; gap: 0; position: relative;">
  ...
  <div style="display: flex; gap: 1.25rem; align-items: flex-start; position: relative; padding-bottom: 1.5rem;">
    ...
    <div style="padding: 1.25rem 1.5rem; background: var(--bg-tertiary); border: 1px solid rgba(167,139,250,0.2); border-radius: 1rem; flex: 1;">
      <p style="margin: 0 0 0.5rem; font-weight: 700; color: var(--text-primary);">Définir le problème avec précision</p>
      <p style="margin: 0; font-size: 0.88rem; color: var(--text-secondary);">Un problème mal défini génère une analyse inutile. Donnez un ancrage factuel : quoi, combien, depuis quand.</p>
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem; margin-top: 1rem;">
        <div style="padding: 0.75rem; background: rgba(239,68,68,0.08); border: 1px solid rgba(239,68,68,0.2); border-radius: 0.6rem;">
          ...
          <div style="font-size: 0.82rem; color: var(--text-secondary);">"On a des problèmes de qualité"</div>
        </div>
        <div style="padding: 0.75rem; background: rgba(110,231,183,0.08); border: 1px solid rgba(110,231,183,0.2); border-radius: 0.6rem;">
          ...
          <div style="font-size: 0.82rem; color: var(--text-secondary);">"20% des commandes ont une erreur de picking, 3h de retraitement/semaine"</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="display: flex; gap: 1.25rem; align-items: flex-start; position: relative; padding-bottom: 1.5rem;">
    ...
    <div style="padding: 1.25rem 1.5rem; background: var(--bg-tertiary); border: 1px solid rgba(167,139,250,0.2); border-radius: 1rem; flex: 1;">
      <p style="margin: 0 0 0.5rem; font-weight: 700; color: var(--text-primary);">Réunir les bonnes personnes</p>
      <p style="margin: 0; font-size: 0.88rem; color: var(--text-secondary);">Les 5 Pourquoi se font avec les personnes qui <strong style="color: var(--text-primary);">vivent le problème au quotidien</strong> — pas avec les managers qui l'observent de loin. Au minimum une personne qui touche le processus directement.</p>
    </div>
  </div>
  ...
  <div style="display: flex; gap: 1.25rem; align-items: flex-start; position: relative; padding-bottom: 1.5rem;">
    ...
    <div style="padding: 1.25rem 1.5rem; background: var(--bg-tertiary); border: 1px solid rgba(167,139,250,0.2); border-radius: 1rem; flex: 1;">
      <p style="margin: 0 0 0.5rem; font-weight: 700; color: var(--text-primary);">Enchaîner les "pourquoi" en remontant</p>
      <p style="margin: 0; font-size: 0.88rem; color: var(--text-secondary);">À chaque niveau, posez la question sur la réponse précédente — pas sur le problème de départ. Vérifiez chaque réponse avec des faits observables, pas des suppositions.</p>
    </div>
  </div>
  ...
  <div style="display: flex; gap: 1.25rem; align-items: flex-start; position: relative; padding-bottom: 1.5rem;">
    ...
    <div style="padding: 1.25rem 1.5rem; background: var(--bg-tertiary); border: 1px solid rgba(167,139,250,0.2); border-radius: 1rem; flex: 1;">
      <p style="margin: 0 0 0.5rem; font-weight: 700; color: var(--text-primary);">Identifier la cause racine actionnable</p>
      <p style="margin: 0; font-size: 0.88rem; color: var(--text-secondary);">Arrêtez-vous quand la réponse mène à quelque chose sur lequel vous <strong style="color: var(--text-primary);">pouvez agir</strong>. Ce n'est pas nécessairement au 5e niveau.</p>
    </div>
  </div>
  ...
  <div style="display: flex; gap: 1.25rem; align-items: flex-start;">
    ...
    <div style="padding: 1.25rem 1.5rem; background: var(--bg-tertiary); border: 1px solid rgba(110,231,183,0.2); border-radius: 1rem; flex: 1;">
      <p style="margin: 0 0 0.5rem; font-weight: 700; color: var(--text-primary);">Définir une action corrective concrète</p>
      <p style="margin: 0; font-size: 0.88rem; color: var(--text-secondary);">Une action, une personne responsable, une date. Puis mesurez dans 30 à 60 jours si le problème a disparu. Pas de liste de recommandations génériques.</p>
    </div>
  </div>
  ...
  <div style="padding: 1.5rem; display: flex; flex-direction: column; gap: 0.5rem;">
    <div style="display: flex; align-items: stretch; gap: 1rem;">
      ...
      <div style="flex: 1; padding: 0.9rem 1rem; background: rgba(239,68,68,0.07); border: 1px solid rgba(239,68,68,0.2); border-radius: 0.75rem; margin-bottom: 0.5rem;">
        ...
        <div style="font-size: 0.88rem; color: var(--text-primary); font-weight: 500;">20% des commandes présentent une erreur de picking à l'expédition → 3,5h de retraitement par semaine</div>
      </div>
    </div>
    <div style="display: flex; align-items: stretch; gap: 1rem;">
      <div style="display: flex; flex-direction: column; align-items: center; width: 32px; flex-shrink: 0;">
      ...
      <div style="flex: 1; padding: 0.9rem 1rem; background: var(--bg-tertiary); border: 1px solid rgba(167,139,250,0.15); border-radius: 0.75rem; margin-bottom: 0.5rem;">
        <div style="display: flex; flex-wrap: wrap; gap: 0.5rem; align-items: baseline;">
          ...
          <span style="font-size: 0.88rem; color: var(--text-secondary);">Les références produits se ressemblent visuellement sur les rayonnages</span>
        </div>
      </div>
    </div>
    <div style="display: flex; align-items: stretch; gap: 1rem;">
      ...
      <div style="flex: 1; padding: 0.9rem 1rem; background: var(--bg-tertiary); border: 1px solid rgba(167,139,250,0.15); border-radius: 0.75rem; margin-bottom: 0.5rem;">
        <div style="display: flex; flex-wrap: wrap; gap: 0.5rem; align-items: baseline;">
          <span style="font-size: 0.72rem; color: #a78bfa; font-family: 'JetBrains Mono', monospace; font-weight: 600;">POURQUOI ?</span>
          <span style="font-size: 0.88rem; color: var(--text-secondary);">Le rangement entrepôt n'est pas organisé par famille de produits</span>
        </div>
      </div>
    </div>
    <div style="display: flex; align-items: stretch; gap: 1rem;">
      ...
      <div style="flex: 1; padding: 0.9rem 1rem; background: var(--bg-tertiary); border: 1px solid rgba(167,139,250,0.15); border-radius: 0.75rem; margin-bottom: 0.5rem;">
        <div style="display: flex; flex-wrap: wrap; gap: 0.5rem; align-items: baseline;">
          <span style="font-size: 0.72rem; color: #a78bfa; font-family: 'JetBrains Mono', monospace; font-weight: 600;">POURQUOI ?</span>
          <span style="font-size: 0.88rem; color: var(--text-secondary);">Le rangement n'a pas été revu depuis le doublement du catalogue produit</span>
        </div>
      </div>
    </div>
    <div style="display: flex; align-items: stretch; gap: 1rem;">
      ...
      <div style="flex: 1; padding: 0.9rem 1rem; background: var(--bg-tertiary); border: 1px solid rgba(167,139,250,0.15); border-radius: 0.75rem; margin-bottom: 0.5rem;">
        <div style="display: flex; flex-wrap: wrap; gap: 0.5rem; align-items: baseline;">
          <span style="font-size: 0.72rem; color: #a78bfa; font-family: 'JetBrains Mono', monospace; font-weight: 600;">POURQUOI ?</span>
          <span style="font-size: 0.88rem; color: var(--text-secondary);">Il n'existe pas de processus de révision périodique de l'organisation entrepôt</span>
        </div>
      </div>
    </div>
    <div style="display: flex; align-items: stretch; gap: 1rem;">
      ...
      <div style="flex: 1; padding: 0.9rem 1rem; background: rgba(110,231,183,0.07); border: 2px solid rgba(110,231,183,0.3); border-radius: 0.75rem;">
        ...
        <div style="font-size: 0.88rem; color: var(--text-primary); font-weight: 500;">La gestion de l'entrepôt n'a pas de responsable désigné — aucune gouvernance pour maintenir l'organisation à jour</div>
        <div style="margin-top: 0.75rem; padding: 0.6rem 0.9rem; background: rgba(110,231,183,0.08); border-radius: 0.5rem; font-size: 0.8rem; color: var(--text-secondary);">
...
<div style="margin: 1.5rem 0; padding: 1.25rem 1.5rem; background: var(--bg-tertiary); border: 1px solid rgba(96,165,250,0.2); border-radius: 1rem;">
  ...
  <div style="display: flex; flex-direction: column; gap: 0.4rem; font-size: 0.85rem;">
    <div><span style="color: #60a5fa; font-weight: 600;">P1 →</span> <span style="color: var(--text-secondary);">Les clients se plaignent de délais de livraison non respectés</span></div>
    <div><span style="color: #60a5fa; font-weight: 600;">P2 →</span> <span style="color: var(--text-secondary);">Les délais affichés sur le site sont souvent dépassés</span></div>
    <div><span style="color: #60a5fa; font-weight: 600;">P3 →</span> <span style="color: var(--text-secondary);">Les délais affichés sont ceux du fournisseur, pas les délais réels incluant la préparation</span></div>
    <div><span style="color: #60a5fa; font-weight: 600;">P4 →</span> <span style="color: var(--text-secondary);">Personne n'a mis à jour le paramétrage lors du changement de prestataire logistique</span></div>
    <div style="padding: 0.6rem; background: rgba(110,231,183,0.08); border-radius: 0.5rem; margin-top: 0.4rem;"><span style="color: #6ee7b7; font-weight: 600;">P5 (racine) →</span> <span style="color: var(--text-primary);">Il n'existe pas de checklist de vérification lors d'un changement prestataire</span></div>
  </div>
</div>

### Exemple 2 — RH et management

<div style="margin: 1.5rem 0; padding: 1.25rem 1.5rem; background: var(--bg-tertiary); border: 1px solid rgba(251,191,36,0.2); border-radius: 1rem;">
  ...
  <div style="display: flex; flex-direction: column; gap: 0.4rem; font-size: 0.85rem;">
    <div><span style="color: #fbbf24; font-weight: 600;">P1 →</span> <span style="color: var(--text-secondary);">Les juniors quittent dans les 12 premiers mois</span></div>
    <div><span style="color: #fbbf24; font-weight: 600;">P2 →</span> <span style="color: var(--text-secondary);">Ils se sentent insuffisamment accompagnés dans leur montée en compétences</span></div>
    <div><span style="color: #fbbf24; font-weight: 600;">P3 →</span> <span style="color: var(--text-secondary);">Il n'y a pas de parcours d'onboarding structuré</span></div>
    <div><span style="color: #fbbf24; font-weight: 600;">P4 →</span> <span style="color: var(--text-secondary);">La construction de l'onboarding avait été planifiée mais jamais livrée</span></div>
    <div style="padding: 0.6rem; background: rgba(110,231,183,0.08); border-radius: 0.5rem; margin-top: 0.4rem;"><span style="color: #6ee7b7; font-weight: 600;">P5 (racine) →</span> <span style="color: var(--text-primary);">Le projet a été confié à un manager sans temps alloué — aucun porteur dédié</span></div>
  </div>
</div>

### Exemple 3 — Production / qualité

<div style="margin: 1.5rem 0; padding: 1.25rem 1.5rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.2); border-radius: 1rem;">
  ...
  <div style="display: flex; flex-direction: column; gap: 0.4rem; font-size: 0.85rem;">
    <div><span style="color: #f87171; font-weight: 600;">P1 →</span> <span style="color: var(--text-secondary);">Le moteur surchauffe</span></div>
    <div><span style="color: #f87171; font-weight: 600;">P2 →</span> <span style="color: var(--text-secondary);">Le système de refroidissement est insuffisant</span></div>
    <div><span style="color: #f87171; font-weight: 600;">P3 →</span> <span style="color: var(--text-secondary);">Le filtre n'a pas été changé depuis 8 mois</span></div>
    <div><span style="color: #f87171; font-weight: 600;">P4 →</span> <span style="color: var(--text-secondary);">Il n'y a aucun rappel de maintenance dans le planning</span></div>
    <div style="padding: 0.6rem; background: rgba(110,231,183,0.08); border-radius: 0.5rem; margin-top: 0.4rem;"><span style="color: #6ee7b7; font-weight: 600;">P5 (racine) →</span> <span style="color: var(--text-primary);">L'équipement ajouté l'an dernier n'a jamais été intégré à la GMAO</span></div>
  </div>
</div>
...
<div style="margin: 2rem 0; border-radius: 1.25rem; overflow: hidden; border: 1px solid rgba(167,139,250,0.25);">
  <div style="display: grid; grid-template-columns: 1fr 1fr;">
    <div style="padding: 1.25rem 1.5rem; background: var(--bg-tertiary); border-right: 1px solid rgba(167,139,250,0.15);">
      ...
      <div style="font-size: 0.88rem; font-weight: 700; color: var(--text-primary); margin-bottom: 0.5rem;">Problème : "Les clients appellent trop"</div>
      <div style="font-size: 0.82rem; color: var(--text-secondary); margin-bottom: 0.75rem;">Solution choisie : déployer un chatbot IA</div>
      <div style="font-size: 0.82rem; color: var(--text-secondary); margin-bottom: 0.75rem;">Budget : 15 000€ + 3 mois de projet</div>
    ...
    <div style="padding: 1.25rem 1.5rem; background: var(--bg-secondary);">
      ...
      <div style="font-size: 0.88rem; font-weight: 700; color: var(--text-primary); margin-bottom: 0.5rem;">P1 → Les clients ne trouvent pas l'info sur le site</div>
      <div style="font-size: 0.82rem; color: var(--text-secondary); margin-bottom: 0.3rem;">P2 → La FAQ est incomplète et mal organisée</div>
      <div style="font-size: 0.82rem; color: var(--text-secondary); margin-bottom: 0.3rem;">P3 → Elle n'a pas été mise à jour depuis 2 ans</div>
      <div style="font-size: 0.82rem; color: var(--text-secondary); margin-bottom: 0.3rem;">P4 → Personne n'en est responsable</div>
...
<div style="margin: 2rem 0; display: flex; flex-direction: column; gap: 0.75rem;">
  ...
  <div style="display: flex; gap: 1rem; align-items: flex-start; padding: 1rem 1.25rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.15); border-radius: 0.9rem;">
    ...
    <div>
      <div style="font-weight: 600; color: var(--text-primary); font-size: 0.88rem; margin-bottom: 0.2rem;">Commencer avec un problème flou</div>
      <div style="font-size: 0.82rem; color: var(--text-secondary);">"On a des problèmes de communication" ne fonctionne pas. Sans ancrage factuel, chaque réponse sera une supposition.</div>
    </div>
  </div>
  ...
  <div style="display: flex; gap: 1rem; align-items: flex-start; padding: 1rem 1.25rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.15); border-radius: 0.9rem;">
    ...
    <div>
      <div style="font-weight: 600; color: var(--text-primary); font-size: 0.88rem; margin-bottom: 0.2rem;">S'arrêter trop tôt</div>
      <div style="font-size: 0.82rem; color: var(--text-secondary);">Les deux premiers "pourquoi" atteignent rarement la cause racine. Ce sont souvent des causes intermédiaires.</div>
    </div>
  </div>
  ...
  <div style="display: flex; gap: 1rem; align-items: flex-start; padding: 1rem 1.25rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.15); border-radius: 0.9rem;">
    ...
    <div>
      <div style="font-weight: 600; color: var(--text-primary); font-size: 0.88rem; margin-bottom: 0.2rem;">Sauter des niveaux</div>
      <div style="font-size: 0.82rem; color: var(--text-secondary);">Passer du problème directement à une cause présumée sans enchaîner les questions intermédiaires mène à de fausses conclusions.</div>
    </div>
  </div>
  ...
  <div style="display: flex; gap: 1rem; align-items: flex-start; padding: 1rem 1.25rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.15); border-radius: 0.9rem;">
    ...
    <div>
      <div style="font-weight: 600; color: var(--text-primary); font-size: 0.88rem; margin-bottom: 0.2rem;">Chercher un coupable</div>
      <div style="font-size: 0.82rem; color: var(--text-secondary);">Les 5 Pourquoi cherchent une cause systémique, pas une faute individuelle. Dès que la session tourne à "c'est la faute de Untel", elle est compromise.</div>
    </div>
  </div>
  ...
  <div style="display: flex; gap: 1rem; align-items: flex-start; padding: 1rem 1.25rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.15); border-radius: 0.9rem;">
    ...
    <div>
      <div style="font-weight: 600; color: var(--text-primary); font-size: 0.88rem; margin-bottom: 0.2rem;">Faire l'exercice seul</div>
      <div style="font-size: 0.82rem; color: var(--text-secondary);">Sans les personnes qui vivent le problème, vous travaillez sur des suppositions. Les meilleures sessions 5 Pourquoi se font avec des gens du terrain.</div>
    </div>
  </div>
  ...
  <div style="display: flex; gap: 1rem; align-items: flex-start; padding: 1rem 1.25rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.15); border-radius: 0.9rem;">
    ...
    <div>
      <div style="font-weight: 600; color: var(--text-primary); font-size: 0.88rem; margin-bottom: 0.2rem;">Ne pas vérifier les réponses avec des faits</div>
      <div style="font-size: 0.82rem; color: var(--text-secondary);">"Je pense que c'est parce que..." n'a pas sa place. Chaque réponse doit être étayée par quelque chose d'observable.</div>
    </div>
  </div>
  ...
  <div style="display: flex; gap: 1rem; align-items: flex-start; padding: 1rem 1.25rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.15); border-radius: 0.9rem;">
    ...
    <div>
      <div style="font-weight: 600; color: var(--text-primary); font-size: 0.88rem; margin-bottom: 0.2rem;">Ne pas définir d'action corrective concrète</div>
      <div style="font-size: 0.82rem; color: var(--text-secondary);">Une session sans action attribuée à une personne avec une date n'a aucune valeur opérationnelle. Ce n'est qu'une conversation.</div>
    </div>
  </div>
...
<div style="margin: 2rem 0; border-radius: 1rem; overflow: hidden; border: 1px solid rgba(167,139,250,0.2);">
  ...
  <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; border-bottom: 1px solid rgba(167,139,250,0.1); background: var(--bg-secondary);">
    <div style="padding: 0.8rem 1rem; font-size: 0.85rem; font-weight: 600; color: #6ee7b7;">5 Pourquoi ★</div>
    <div style="padding: 0.8rem 1rem; font-size: 0.82rem; color: var(--text-secondary); border-left: 1px solid rgba(167,139,250,0.1);">Problème unique, bien délimité. Rapide à mettre en œuvre.</div>
    <div style="padding: 0.8rem 1rem; font-size: 0.82rem; color: var(--text-secondary); border-left: 1px solid rgba(167,139,250,0.1);">Moins adapté aux problèmes très multicausaux</div>
  </div>
  <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; border-bottom: 1px solid rgba(167,139,250,0.1);">
    <div style="padding: 0.8rem 1rem; font-size: 0.85rem; font-weight: 600; color: var(--text-primary);">Ishikawa</div>
    <div style="padding: 0.8rem 1rem; font-size: 0.82rem; color: var(--text-secondary); border-left: 1px solid rgba(167,139,250,0.1);">Explorer toutes les causes possibles d'un problème complexe</div>
    <div style="padding: 0.8rem 1rem; font-size: 0.82rem; color: var(--text-secondary); border-left: 1px solid rgba(167,139,250,0.1);">Ne hiérarchise pas les causes par importance</div>
  </div>
  <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; border-bottom: 1px solid rgba(167,139,250,0.1);">
    <div style="padding: 0.8rem 1rem; font-size: 0.85rem; font-weight: 600; color: var(--text-primary);">FMEA</div>
    <div style="padding: 0.8rem 1rem; font-size: 0.82rem; color: var(--text-secondary); border-left: 1px solid rgba(167,139,250,0.1);">Anticiper les risques avant qu'ils surviennent</div>
    <div style="padding: 0.8rem 1rem; font-size: 0.82rem; color: var(--text-secondary); border-left: 1px solid rgba(167,139,250,0.1);">Lourde à mettre en œuvre, nécessite une expertise</div>
  </div>
  <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; border-bottom: 1px solid rgba(167,139,250,0.1);">
    <div style="padding: 0.8rem 1rem; font-size: 0.85rem; font-weight: 600; color: var(--text-primary);">Arbre des causes</div>
    <div style="padding: 0.8rem 1rem; font-size: 0.82rem; color: var(--text-secondary); border-left: 1px solid rgba(167,139,250,0.1);">Accidents, incidents complexes avec plusieurs scénarios</div>
    <div style="padding: 0.8rem 1rem; font-size: 0.82rem; color: var(--text-secondary); border-left: 1px solid rgba(167,139,250,0.1);">Nécessite une formation spécifique, plus long</div>
  </div>
  <div style="display: grid; grid-template-columns: 1fr 1fr 1fr;">
    <div style="padding: 0.8rem 1rem; font-size: 0.85rem; font-weight: 600; color: var(--text-primary);">A3 Toyota</div>
    <div style="padding: 0.8rem 1rem; font-size: 0.82rem; color: var(--text-secondary); border-left: 1px solid rgba(167,139,250,0.1);">Plan d'action complet, documentation structurée</div>
    <div style="padding: 0.8rem 1rem; font-size: 0.82rem; color: var(--text-secondary); border-left: 1px solid rgba(167,139,250,0.1);">Trop lourd pour les problèmes simples ou urgents</div>
  </div>
</div>
...
<div style="margin: 1.5rem 0; display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
  <div style="padding: 1.1rem; background: var(--bg-tertiary); border: 1px solid rgba(167,139,250,0.2); border-radius: 0.9rem;">
    <div style="font-size: 1.5rem; margin-bottom: 0.5rem;">🖊️</div>
    <div style="font-weight: 600; font-size: 0.88rem; color: var(--text-primary); margin-bottom: 0.3rem;">Présentiel</div>
    <div style="font-size: 0.8rem; color: var(--text-secondary);">Tableau blanc ou paper board. Idéal pour visualiser la chaîne causale en temps réel avec le groupe.</div>
  </div>
  <div style="padding: 1.1rem; background: var(--bg-tertiary); border: 1px solid rgba(167,139,250,0.2); border-radius: 0.9rem;">
    <div style="font-size: 1.5rem; margin-bottom: 0.5rem;">📊</div>
    <div style="font-weight: 600; font-size: 0.88rem; color: var(--text-primary); margin-bottom: 0.3rem;">Template numérique</div>
    <div style="font-size: 0.8rem; color: var(--text-secondary);">Google Sheets ou Notion : tableau à 6 lignes avec Niveau / Question / Réponse / Source / Action.</div>
  </div>
  <div style="padding: 1.1rem; background: var(--bg-tertiary); border: 1px solid rgba(167,139,250,0.2); border-radius: 0.9rem;">
    <div style="font-size: 1.5rem; margin-bottom: 0.5rem;">🎨</div>
    <div style="font-weight: 600; font-size: 0.88rem; color: var(--text-primary); margin-bottom: 0.3rem;">Distanciel</div>
    <div style="font-size: 0.8rem; color: var(--text-secondary);">FigJam ou Miro pour les sessions multi-participants à distance, avec post-its et liens visuels.</div>
  </div>
  <div style="padding: 1.1rem; background: var(--bg-tertiary); border: 1px solid rgba(167,139,250,0.2); border-radius: 0.9rem;">
    <div style="font-size: 1.5rem; margin-bottom: 0.5rem;">⚙️</div>
    <div style="font-weight: 600; font-size: 0.88rem; color: var(--text-primary); margin-bottom: 0.3rem;">Qualité industrielle</div>
    <div style="font-size: 0.8rem; color: var(--text-secondary);">GMAO ou logiciels qualité (Qualios, Intelex) — pertinents uniquement pour des équipes qualité avec de nombreuses sessions.</div>
  </div>
</div>

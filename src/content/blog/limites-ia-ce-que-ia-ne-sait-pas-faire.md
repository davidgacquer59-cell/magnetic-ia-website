...
<div style="margin: 2rem 0; border-radius: 1.25rem; overflow: hidden; border: 1px solid rgba(239,68,68,0.25);">
  ...
  <div style="padding: 1.5rem; display: flex; flex-direction: column; gap: 0.75rem;">
    <div style="display: flex; gap: 0.75rem; align-items: flex-start; padding: 0.9rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.12); border-radius: 0.75rem;">
      <div style="font-size: 1rem; flex-shrink: 0;">⚖️</div>
      <div style="font-size: 0.85rem; color: var(--text-secondary); line-height: 1.6;"><strong style="color: var(--text-primary);">Droit :</strong> citations de jurisprudence inventées, avec numéros de décision plausibles mais inexistants. Des avocats ont soumis des plaidoiries avec ces fausses références sans vérifier.</div>
    </div>
    <div style="display: flex; gap: 0.75rem; align-items: flex-start; padding: 0.9rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.12); border-radius: 0.75rem;">
      <div style="font-size: 1rem; flex-shrink: 0;">🔬</div>
      <div style="font-size: 0.85rem; color: var(--text-secondary); line-height: 1.6;"><strong style="color: var(--text-primary);">Sciences :</strong> études scientifiques inventées avec auteurs, revues et dates cohérents. Introuvables parce qu'elles n'existent pas.</div>
    </div>
    <div style="display: flex; gap: 0.75rem; align-items: flex-start; padding: 0.9rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.12); border-radius: 0.75rem;">
      <div style="font-size: 1rem; flex-shrink: 0;">📊</div>
      <div style="font-size: 0.85rem; color: var(--text-secondary); line-height: 1.6;"><strong style="color: var(--text-primary);">Chiffres :</strong> statistiques inventées sur des marchés, présentées avec des sources d'apparence crédible (INSEE, Gartner) qui ne correspondent à aucun rapport réel.</div>
    </div>
  </div>
</div>
...
<div style="margin: 2rem 0; display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
  <div style="padding: 1.25rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.15); border-radius: 0.9rem;">
    ...
    <div style="font-size: 0.88rem; color: var(--text-secondary); font-style: italic; margin-bottom: 0.75rem;">"Rédige un email pour mon client mécontent."</div>
    <div style="font-size: 0.83rem; color: var(--text-secondary);">L'IA rédige un email standard de gestion de réclamation. Aucune mention du contexte spécifique, du ton habituel de votre relation client, ni de ce que vous proposez réellement pour résoudre le problème.</div>
  </div>
  <div style="padding: 1.25rem; background: var(--bg-tertiary); border: 1px solid rgba(110,231,183,0.15); border-radius: 0.9rem;">
    ...
    <div style="font-size: 0.88rem; color: var(--text-secondary); font-style: italic; margin-bottom: 0.75rem;">"Client historique, 5 ans, erreur de livraison de notre côté, je veux m'excuser sincèrement et lui proposer un avoir de 15%."</div>
    <div style="font-size: 0.83rem; color: var(--text-secondary);">Avec ces informations, l'IA peut produire un email vraiment adapté à la situation, au ton de votre relation, et à la solution concrète que vous proposez.</div>
  </div>
</div>
...
<div style="margin: 2rem 0; padding: 1.25rem 1.5rem; background: var(--bg-tertiary); border: 1px solid rgba(167,139,250,0.2); border-radius: 1rem;">
  <p style="margin: 0 0 0.5rem; font-weight: 600; color: var(--text-primary); font-size: 0.9rem;">Ce que ça signifie concrètement</p>
...
<div style="margin: 2rem 0; border-radius: 1.25rem; overflow: hidden; border: 1px solid rgba(239,68,68,0.2);">
  ...
  <div style="padding: 1.5rem; display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 0.75rem;">
    <div style="padding: 0.9rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.12); border-radius: 0.75rem;">
      <div style="font-size: 1.1rem; margin-bottom: 0.4rem;">👤</div>
      <div style="font-size: 0.82rem; font-weight: 600; color: var(--text-primary); margin-bottom: 0.2rem;">Données clients</div>
      <div style="font-size: 0.78rem; color: var(--text-secondary);">Noms, coordonnées, historique d'achats, données de facturation</div>
    </div>
    <div style="padding: 0.9rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.12); border-radius: 0.75rem;">
      <div style="font-size: 1.1rem; margin-bottom: 0.4rem;">💼</div>
      <div style="font-size: 0.82rem; font-weight: 600; color: var(--text-primary); margin-bottom: 0.2rem;">Données salariés</div>
      <div style="font-size: 0.78rem; color: var(--text-secondary);">Fiches de paie, évaluations, données médicales, contrats</div>
    </div>
    <div style="padding: 0.9rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.12); border-radius: 0.75rem;">
      <div style="font-size: 1.1rem; margin-bottom: 0.4rem;">🔐</div>
      <div style="font-size: 0.82rem; font-weight: 600; color: var(--text-primary); margin-bottom: 0.2rem;">Informations confidentielles</div>
      <div style="font-size: 0.78rem; color: var(--text-secondary);">Stratégie, négociations en cours, formules, brevets</div>
    </div>
    <div style="padding: 0.9rem; background: var(--bg-tertiary); border: 1px solid rgba(239,68,68,0.12); border-radius: 0.75rem;">
      <div style="font-size: 1.1rem; margin-bottom: 0.4rem;">💰</div>
      <div style="font-size: 0.82rem; font-weight: 600; color: var(--text-primary); margin-bottom: 0.2rem;">Données financières</div>
      <div style="font-size: 0.78rem; color: var(--text-secondary);">Résultats non publiés, marges, plans de financement</div>
    </div>
  </div>
</div>
...
<div style="margin: 2rem 0; padding: 0; border-radius: 1.25rem; overflow: hidden; border: 1px solid rgba(251,191,36,0.2);">
  ...
  <div style="padding: 1.5rem; display: flex; flex-direction: column; gap: 0.75rem;">
    <div style="display: flex; gap: 0.75rem; align-items: center;">
      ...
      <div style="font-size: 0.85rem; color: var(--text-secondary);">La qualité de l'output dépend de la qualité de l'input — c'est une règle absolue</div>
    </div>
    <div style="display: flex; gap: 0.75rem; align-items: center;">
      <div style="width: 8px; height: 8px; border-radius: 50%; background: #fbbf24; flex-shrink: 0;"></div>
      <div style="font-size: 0.85rem; color: var(--text-secondary);">Écrire de bons prompts est une compétence qui s'apprend — pas un talent inné</div>
    </div>
    <div style="display: flex; gap: 0.75rem; align-items: center;">
      <div style="width: 8px; height: 8px; border-radius: 50%; background: #fbbf24; flex-shrink: 0;"></div>
      <div style="font-size: 0.85rem; color: var(--text-secondary);">Les prompts s'améliorent par itérations — il faut accepter de raffiner</div>
    </div>
    <div style="display: flex; gap: 0.75rem; align-items: center;">
      <div style="width: 8px; height: 8px; border-radius: 50%; background: #fbbf24; flex-shrink: 0;"></div>
      <div style="font-size: 0.85rem; color: var(--text-secondary);">Un prompt bien structuré vaut beaucoup plus qu'un outil IA "plus puissant"</div>
    </div>
  </div>
</div>
  ...
  <div style="display: grid; grid-template-columns: 1fr 1fr;">
    <div style="padding: 1.25rem 1.5rem; border-right: 1px solid rgba(167,139,250,0.15);">
      ...
      <div style="display: flex; flex-direction: column; gap: 0.5rem;">
        <div style="font-size: 0.85rem; color: var(--text-secondary);">Rédaction, reformulation, synthèse</div>
        <div style="font-size: 0.85rem; color: var(--text-secondary);">Structure et organisation d'information</div>
        <div style="font-size: 0.85rem; color: var(--text-secondary);">Brainstorming et génération d'idées</div>
        <div style="font-size: 0.85rem; color: var(--text-secondary);">Tâches répétitives bien définies</div>
        <div style="font-size: 0.85rem; color: var(--text-secondary);">Traitement de textes longs (résumés, extraction)</div>
        <div style="font-size: 0.85rem; color: var(--text-secondary);">Traduction et adaptation de ton</div>
      </div>
    </div>
    <div style="padding: 1.25rem 1.5rem;">
      ...
      <div style="display: flex; flex-direction: column; gap: 0.5rem;">
        <div style="font-size: 0.85rem; color: var(--text-secondary);">Faits précis (à vérifier systématiquement)</div>
        <div style="font-size: 0.85rem; color: var(--text-secondary);">Expertise métier spécifique</div>
        <div style="font-size: 0.85rem; color: var(--text-secondary);">Contexte non fourni dans le prompt</div>
        <div style="font-size: 0.85rem; color: var(--text-secondary);">Données sensibles (risque légal)</div>
        <div style="font-size: 0.85rem; color: var(--text-secondary);">Informations récentes ou temps réel</div>
        <div style="font-size: 0.85rem; color: var(--text-secondary);">Décision et jugement stratégique</div>
      </div>
    </div>
  </div>
</div>
